...
const PRODUCTS = [
  { id: "prod-sea-cucumber", name: "Sandfish Sea Cucumber", slug: "sea-cucumber", categoryId: "cat-sea-cucumber", description: "Premium quality sea cucumber sourced from the sea.", pricePerKg: 891, unit: "kg", available: true, featured: true, image: "images/sea-cucumber.jpeg" },
  { id: "prod-sea-shells", name: "Sea Shells", slug: "sea-shells", categoryId: "cat-sea-shells", description: "Natural and premium quality sea shells sourced from the sea.", pricePerKg: 801, unit: "pcs", available: true, featured: true, image: "images/sea-shells.jpeg" },

  // ---- Sea Cucumber varieties ----
  { id: "prod-curry-fish", name: "Curry Fish Sea Cucumber", slug: "curry-fish", categoryId: "cat-sea-cucumber", description: "Dried Curry Fish sea cucumber, hand-graded for size and quality. Update pricing anytime in admin.", pricePerKg: 941, unit: "kg", available: true, featured: true, image: "images/curry-fish.jpg" },
  { id: "prod-curry-fish-white", name: "Curry Fish (White Grade)", slug: "curry-fish-white", categoryId: "cat-sea-cucumber", description: "Bleached, white-grade Curry Fish sea cucumber. Update pricing anytime in admin.", pricePerKg: 991, unit: "kg", available: true, featured: false, image: "images/curry-fish-white.jpg" },
  { id: "prod-baby-curry-fish", name: "Baby Curry Fish", slug: "baby-curry-fish", categoryId: "cat-sea-cucumber", description: "Smaller-sized, dark-grade Curry Fish sea cucumber. Update pricing anytime in admin.", pricePerKg: 741, unit: "kg", available: true, featured: false, image: "images/baby-curry-fish.jpg" },
  { id: "prod-golden-sandfish-2", name: "Golden Sandfish Sea Cucumber", slug: "golden-sandfish-premium", categoryId: "cat-sea-cucumber", description: "Premium dried Golden Sandfish sea cucumber. Update pricing anytime in admin.", pricePerKg: 124, unit: "kg", available: true, featured: true, image: "images/golden-sandfish-2.jpg" },
  { id: "prod-loli-fish", name: "Lolly Fish Sea Cucumber", slug: "loli-fish", categoryId: "cat-sea-cucumber", description: "Dried Loli Fish sea cucumber, dark grade. Update pricing anytime in admin.", pricePerKg: 841, unit: "kg", available: true, featured: false, image: "images/loli-fish.webp" },
  { id: "prod-sanfish", name: "Sanfish", slug: "sanfish", categoryId: "cat-sea-cucumber", description: "Dried Sanfish sea cucumber, ridged skin, sourced and graded for export. Update pricing anytime in admin.", pricePerKg: 891, unit: "kg", available: true, featured: false, image: "images/sanfish.jpg" },
  { id: "prod-whate-nool", name: "Whate Nool", slug: "whate-nool", categoryId: "cat-sea-cucumber", description: "Dried Whate Nool sea cucumber. Update pricing anytime in admin.", pricePerKg: 7958, unit: "kg", available: true, featured: false, image: "images/whate-nool.jpg" },
  { id: "prod-whate-tiger", name: "White Tiger Sea Cucumber", slug: "whate-tiger", categoryId: "cat-sea-cucumber", description: "Dried Whate Tiger sea cucumber with distinctive textured skin. Update pricing anytime in admin.", pricePerKg: 109, unit: "kg", available: true, featured: false, image: "images/whate-tiger.jpg" },
  { id: "prod-xiang-pi", name: "Xiang Pi", slug: "xiang-pi", categoryId: "cat-sea-cucumber", description: "Dried Xiang Pi sea cucumber. Update pricing anytime in admin.", pricePerKg: 945, unit: "kg", available: true, featured: false, image: "images/xiang-pi.jpg" },
  { id: "prod-dhambela", name: "Dhambela", slug: "dhambela", categoryId: "cat-sea-cucumber", description: "Dried Dhambela sea cucumber. Update pricing anytime in admin.", pricePerKg: 845, unit: "kg", available: true, featured: false, image: "images/dhambela.jpg" },
  { id: "prod-surf-red-fish", name: "Surf Red Fish Sea Cucumber", slug: "surf-red-fish", categoryId: "cat-sea-cucumber", description: "Update pricing anytime in admin.", pricePerKg: 895, unit: "kg", available: true, featured: false, image: "images/surf-red-fish.png" },
  { id: "prod-black-tiger", name: "Black Tiger Sea Cucumber", slug: "black-tiger-sea-cucumber", categoryId: "cat-sea-cucumber", description: "Update pricing anytime in admin.", pricePerKg: 895, unit: "kg", available: true, featured: false, image: "images/black-tiger-sea-cucumber.png" },
  { id: "prod-black-fish", name: "Black Fish Sea Cucumber", slug: "black-fish-sea-cucumber", categoryId: "cat-sea-cucumber", description: "Update pricing anytime in admin.", pricePerKg: 895, unit: "kg", available: true, featured: false, image: "images/black-fish-sea-cucumber.png" },

  // ---- Sea Shell varieties ----
  { id: "prod-patty-shell", name: "Patty Shell", slug: "patty-shell", categoryId: "cat-sea-shells", description: "Natural Patty sea shells, hand selected. Update pricing anytime in admin.", pricePerKg: 858, unit: "pcs", available: true, featured: true, image: "images/patty-shell.jpg" },
  { id: "prod-kachchan-shell", name: "Kachchan Shell", slug: "kachchan-shell", categoryId: "cat-sea-shells", description: "Natural Kachchan sea shells, hand selected. Update pricing anytime in admin.", pricePerKg: 808, unit: "pcs", available: true, featured: false, image: "images/kachchan-shell.jpg" },
  { id: "prod-tapasiyem-shell", name: "Tapasiyem Shell", slug: "tapasiyem-shell", categoryId: "cat-sea-shells", description: "Natural Tapasiyem sea shells with banded patterning. Update pricing anytime in admin.", pricePerKg: 838, unit: "pcs", available: true, featured: false, image: "images/tapasiyem-shell.jpg" },
  { id: "prod-gavuri-shell", name: "Gavuri Shell", slug: "gavuri-shell", categoryId: "cat-sea-shells", description: "Natural Gavuri sea shells, hand selected. Update pricing anytime in admin.", pricePerKg: 808, unit: "pcs", available: true, featured: false, image: "images/gavuri-shell.jpg" },
  { id: "prod-jathi-shell", name: "Jathi Shell", slug: "jathi-shell", categoryId: "cat-sea-shells", description: "Natural Jathi sea shells, hand selected. Update pricing anytime in admin.", pricePerKg: 808, unit: "pcs", available: true, featured: false, image: "images/jathi-shell.jpg" },

  // ---- Other Seafood Products ----
  { id: "prod-dried-sea-snail", name: "Dried Sea Snail", slug: "dried-sea-snail", categoryId: "cat-other", description: "Dried sea snail meat, cleaned and prepared. Update pricing anytime in admin.", pricePerKg: 645, unit: "kg", available: true, featured: true, image: "images/dried-sea-snail.jpg" },
  { id: "prod-dried-sea-snail-white", name: "Dried Sea Snail (White Grade)", slug: "dried-sea-snail-white", categoryId: "cat-other", description: "Dried sea snail meat, white grade, cleaned and prepared. Update pricing anytime in admin.", pricePerKg: 695, unit: "kg", available: true, featured: false, image: "images/dried-sea-snail-white.jpg" },
  { id: "prod-sea-operculum-1", name: "Spider Conch Operculum", slug: "sea-operculum-natural", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 595, unit: "kg", available: true, featured: false, image: "images/operculum-1.jpg" },
  ...
  { id: "prod-sea-operculum-3", name: "Turbinella Pyrum Shell Operculum (Grade B)", slug: "sea-operculum-dark", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 545, unit: "kg", available: true, featured: false, image: "images/operculum-3.jpg" },
  { id: "prod-sea-operculum-4", name: "Trapezium Shell Operculum (Grade B)", slug: "sea-operculum-golden", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 695, unit: "kg", available: true, featured: false, image: "images/operculum-4.webp" },
  { id: "prod-sea-operculum-5", name: "Turbinella Pyrum Shell Operculum", slug: "sea-operculum-mixed", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 545, unit: "kg", available: true, featured: false, image: "images/operculum-5.jpg" },
  { id: "prod-sea-operculum-6", name: "Murex Operculum (Grade B)", slug: "sea-operculum-premium-red", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 745, unit: "kg", available: true, featured: false, image: "images/operculum-6.avif" },
  { id: "prod-trapezium-operculum", name: "Trapezium Shell Operculum", slug: "trapezium-shell-operculum", categoryId: "cat-other", description: "Update pricing anytime in admin.", pricePerKg: 595, unit: "kg", available: true, featured: false, image: "images/trapezium-shell-operculum.jpg" },

  // ---- More Sea Shell varieties ----
  { id: "prod-babylonia-shell", name: "Babylonia Shell", slug: "babylonia-shell", categoryId: "cat-sea-shells", description: "Natural Babylonia (whelk) sea shells with mottled brown patterning. Update pricing anytime in admin.", pricePerKg: 908, unit: "pcs", available: true, featured: false, image: "images/babylonia-shell.webp" },
  { id: "prod-cone-shell-1", name: "Cone Shell", slug: "cone-shell", categoryId: "cat-sea-shells", description: "Natural cone sea shell, hand selected. Update pricing anytime in admin.", pricePerKg: 958, unit: "pcs", available: true, featured: false, image: "images/cone-shell-1.webp" },
  { id: "prod-frog-shell-1", name: "Frog Shell", slug: "frog-shell", categoryId: "cat-sea-shells", description: "Natural frog sea shell with banded brown patterning. Update pricing anytime in admin.", pricePerKg: 858, unit: "pcs", available: true, featured: false, image: "images/frog-shell-1.jpg" },
  { id: "prod-frog-shell-2", name: "Frog Shell (Pair Grade)", slug: "frog-shell-pair", categoryId: "cat-sea-shells", description: "Natural frog sea shells, matched pair grade. Update pricing anytime in admin.", pricePerKg: 878, unit: "pcs", available: true, featured: false, image: "images/frog-shell-2.jpg" },
  { id: "prod-spindle-shell", name: "Spindle Shell", slug: "spindle-shell", categoryId: "cat-sea-shells", description: "Natural spindle sea shell with fine striped patterning. Update pricing anytime in admin.", pricePerKg: 908, unit: "pcs", available: true, featured: false, image: "images/spindle-shell.jpg" },
  { id: "prod-murex-shell", name: "Murex Shell", slug: "murex-shell", categoryId: "cat-sea-shells", description: "Natural Murex sea shell with distinctive spiky, frilled edges. Update pricing anytime in admin.", pricePerKg: 105, unit: "pcs", available: true, featured: false, image: "images/murex-shell.jpg" },
  { id: "prod-cone-shell-2", name: "Cone Shell (Textile Grade)", slug: "cone-shell-textile", categoryId: "cat-sea-shells", description: "Natural textile cone sea shells, orange zigzag patterning. Update pricing anytime in admin.", pricePerKg: 958, unit: "pcs", available: true, featured: false, image: "images/cone-shell-2.jpg" },
  { id: "prod-cone-shell-3", name: "Cone Shell (Single Grade)", slug: "cone-shell-single", categoryId: "cat-sea-shells", description: "Natural cone sea shell, single piece grade. Update pricing anytime in admin.", pricePerKg: 938, unit: "pcs", available: true, featured: false, image: "images/cone-shell-3.jpg" },
].map(product => ({
  ...product,
...
const GALLERY_ITEMS = [
  ...
  { id:"g15", title:"Graded sea cucumber", category:"Sea Cucumber", image:"images/sea-cucumber.jpeg" },
  { id:"g16", title:"Dried sea cucumber, Sanfish grade", category:"Sea Cucumber", image:"images/dried-sea-cucumber-sanfish.jpeg" },
  { id:"g17", title:"Golden Sandfish", category:"Sea Cucumber", image:"images/golden-sandfish.jpeg" },
  { id:"g18", title:"Natural sea shells", category:"Sea Shells", image:"images/sea-shells.jpeg" },
  { id:"g19", title:"Sea shells, hand selected", category:"Sea Shells", image:"images/sea-shells-hand-selected.jpeg" },
  { id:"g20", title:"Curry Fish sea cucumber", category:"Sea Cucumber", image:"images/curry-fish.jpg" },
  { id:"g21", title:"Curry Fish, white grade", category:"Sea Cucumber", image:"images/curry-fish-white.jpg" },
  { id:"g22", title:"Baby Curry Fish sea cucumber", category:"Sea Cucumber", image:"images/baby-curry-fish.jpg" },
  { id:"g23", title:"Golden Sandfish, premium grade", category:"Sea Cucumber", image:"images/golden-sandfish-2.jpg" },
  { id:"g24", title:"Loli Fish sea cucumber", category:"Sea Cucumber", image:"images/loli-fish.webp" },
  { id:"g25", title:"Sanfish sea cucumber", category:"Sea Cucumber", image:"images/sanfish.jpg" },
  { id:"g26", title:"Whate Nool sea cucumber", category:"Sea Cucumber", image:"images/whate-nool.jpg" },
  { id:"g27", title:"Whate Tiger sea cucumber", category:"Sea Cucumber", image:"images/whate-tiger.jpg" },
  { id:"g28", title:"Xiang Pi sea cucumber", category:"Sea Cucumber", image:"images/xiang-pi.jpg" },
  { id:"g29", title:"Dhambela sea cucumber", category:"Sea Cucumber", image:"images/dhambela.jpg" },
  { id:"g30", title:"Patty sea shells", category:"Sea Shells", image:"images/patty-shell.jpg" },
  { id:"g31", title:"Kachchan sea shells", category:"Sea Shells", image:"images/kachchan-shell.jpg" },
  { id:"g32", title:"Tapasiyem sea shells", category:"Sea Shells", image:"images/tapasiyem-shell.jpg" },
  { id:"g33", title:"Gavuri sea shells", category:"Sea Shells", image:"images/gavuri-shell.jpg" },
  { id:"g34", title:"Jathi sea shells", category:"Sea Shells", image:"images/jathi-shell.jpg" },
  { id:"g35", title:"Dried sea snail", category:"Seafood Products", image:"images/dried-sea-snail.jpg" },
  { id:"g36", title:"Dried sea snail, white grade", category:"Seafood Products", image:"images/dried-sea-snail-white.jpg" },
  { id:"g37", title:"Sea operculum", category:"Seafood Products", image:"images/operculum-1.jpg" },
  { id:"g38", title:"Sea operculum, close grade", category:"Seafood Products", image:"images/operculum-2.jpg" },
  { id:"g39", title:"Sea operculum, dark grade", category:"Seafood Products", image:"images/operculum-3.jpg" },
  { id:"g40", title:"Sea operculum, white grade", category:"Seafood Products", image:"images/operculum-4.webp" },
  { id:"g41", title:"Sea operculum, mixed lot", category:"Seafood Products", image:"images/operculum-5.jpg" },
  { id:"g42", title:"Sea operculum, bulk lot", category:"Seafood Products", image:"images/operculum-6.avif" },
  { id:"g43", title:"Babylonia shell", category:"Sea Shells", image:"images/babylonia-shell.webp" },
  { id:"g44", title:"Cone shell", category:"Sea Shells", image:"images/cone-shell-1.webp" },
  { id:"g45", title:"Frog shell", category:"Sea Shells", image:"images/frog-shell-1.jpg" },
  { id:"g46", title:"Frog shell pair", category:"Sea Shells", image:"images/frog-shell-2.jpg" },
  { id:"g47", title:"Spindle shell", category:"Sea Shells", image:"images/spindle-shell.jpg" },
  { id:"g48", title:"Murex shell", category:"Sea Shells", image:"images/murex-shell.jpg" },
  { id:"g49", title:"Cone shell, textile grade", category:"Sea Shells", image:"images/cone-shell-2.jpg" },
  { id:"g50", title:"Cone shell, single grade", category:"Sea Shells", image:"images/cone-shell-3.jpg" },
];
